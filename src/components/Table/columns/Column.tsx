 ...
 * @param {Record<string, any> | null} props._rowdata - The data object for the current row. Ignored if `_isheader` is true.
  ...
  return (
    <TableCell
      ...
      className={clsx(
        ...
        _rowdata![target] && _rowdata![target] < 75 ? "text-red-500!" : "",
      )}
    >
      {_rowdata![target] || "N/A"}
    </TableCell>

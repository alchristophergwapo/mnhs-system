...
export default function UserMenu() {
  ...
  /**
   * Handles the click event on a button element by setting the anchor element.
   * This is typically used to position popover components like menus or dropdowns.
   *
  ...
  /**
   * Handles the user logout process asynchronously.
   * Signs the user out, resets the anchor element state, and redirects to the login page.
   * @async
   * @function handleLogout
   * @returns {Promise<void>} A promise that resolves when the logout and redirection processes are complete.
   */
    ...
    <>
      ...
      >
        {user?.avatar ? (
          ...
          <Avatar sx={{ width: 32, height: 32 }} className="text-white! dark:text-inherit!">
